...
namespace RTD_DataViewer.View
{
    public partial class CarrierInfomation : UserControl
    {
        ...
        private void SearchCstInfo()
        {
            ...
            new WinformUtils(main).SearchCstInfo(dgv_CarrierInfomation.DgvData, latb_CarrierId.Tb_Text, ref errMsg);
        ...
        private void CstActHistSearch()
        {
            ...
            try
            {
                if (cstid != string.Empty)
                {
                    ...
                    new WinformUtils(main).ExcuteSql(paramaterDic, dgv_CarrierActHistory.DgvData, main.correntConnectionStringSetting, MethodBase.GetCurrentMethod().Name);
        ...
        private void CstEventHistSearch()
        {
            ...
            try
            {
                if (cstid != string.Empty)
                {
                    ...
                    new WinformUtils(main).ShowSqltoDGV(dgv_CarrierEventHistory.DgvData, cquery, parameters, main.correntConnectionStringSetting);
