...
{
    public partial class TransportJobAndPortRequestHistory : UserControl
    {
        MainViewer main;

        public TransportJobAndPortRequestHistory(MainViewer main)
        {
            InitializeComponent();
            this.main = main;
        ...
        private void SearchTransfer()
        {
            ...
            try
            {
                ...
                new WinformUtils(main).ExcuteSql(paramaterDic, dgv_PortRequestHistory.DgvData, main.correntConnectionStringSetting, MethodBase.GetCurrentMethod().Name);
            }
            catch (Exception ex)
            {
        ...
        private void SearchDeleteTransfer()
        {
            ...
            try
            {
                ...
                new WinformUtils(main).ShowSqltoDGV(dgv_PortRequestHistory.DgvData, cquery, parameters, main.correntConnectionStringSetting);
            }
            catch (Exception ex)
            {
